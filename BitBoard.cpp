...
{
	Boards[idx(Turn::WHITE)][idx(ChessPiece::PAWN)] = new BitBoard("", 0x000000000000FF00ULL);
	Boards[idx(Turn::BLACK)][idx(ChessPiece::PAWN)] = new BitBoard("", 0x0000000000000000ULL);

	Boards[idx(Turn::WHITE)][idx(ChessPiece::KING)] = new BitBoard("", 0x0000000000000010ULL);
	Boards[idx(Turn::BLACK)][idx(ChessPiece::KING)] = new BitBoard("", 0x1000000000000000ULL);

	Boards[idx(Turn::WHITE)][idx(ChessPiece::QUEEN)] = new BitBoard("", 0x0000000000000008ULL);
	Boards[idx(Turn::BLACK)][idx(ChessPiece::QUEEN)] = new BitBoard("", 0x0800000000000000ULL);

	Boards[idx(Turn::WHITE)][idx(ChessPiece::ROOK)] = new BitBoard("", 0x0000000000000081ULL);
	Boards[idx(Turn::BLACK)][idx(ChessPiece::ROOK)] = new BitBoard("", 0x8100000000000000ULL);

	Boards[idx(Turn::WHITE)][idx(ChessPiece::BISHOP)] = new BitBoard("", 0x0000000000000024ULL);
	Boards[idx(Turn::BLACK)][idx(ChessPiece::BISHOP)] = new BitBoard("", 0x2400000000000000ULL);

	Boards[idx(Turn::WHITE)][idx(ChessPiece::KNIGHT)] = new BitBoard("", 0x0000000000000042ULL);
	Boards[idx(Turn::BLACK)][idx(ChessPiece::KNIGHT)] = new BitBoard("", 0x4200000000000000ULL);
