...
public:
	...
	virtual std::pair<float, bool> get_value_and_terminated(State& state, int& action) = 0;
	...
	virtual std::vector<EncodedState> get_encoded_state_parallel(const std::vector<State>& states) = 0;
